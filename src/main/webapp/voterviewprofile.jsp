	...
	<%
		...
		{		
			...
			String str1=(String)session.getAttribute("username");
				...
				String sql="select voter_id,first_name,last_name,father_name,dob,state,city,address,email,contact_no,pin_code,username,gender from voter where username='"+str1+"'";
