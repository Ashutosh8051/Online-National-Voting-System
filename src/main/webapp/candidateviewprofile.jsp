	...
	<%
		...
		{		
			...
			String str1=(String)session.getAttribute("username");
				...
				String sql="select candidate_id,first_name,last_name,father_name,dob,state,city,party_name,address,email,contact_no,pin_code,username,gender,election_region from candidate where username='"+str1+"'";
