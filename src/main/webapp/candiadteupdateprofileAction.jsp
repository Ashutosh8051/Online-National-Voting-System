...
try
{
	...
	String sql="update candidate set first_name='"+fname+"',last_name='"+lname+"',father_name='"+fathername+"',dob='"+dob+"',state='"+state+"',city='"+city+"',address='"+address+"',email='"+email+"',contact_no='"+contactno+"',pin_code='"+pincode+"'where candidate_id='"+canid+"'";
