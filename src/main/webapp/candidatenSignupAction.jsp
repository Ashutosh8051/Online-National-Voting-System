...
<body>
	...
	try
	{
		...
		String answer=request.getParameter("t18");
			...
			String sql="insert into candidate(first_name,last_name,father_name,dob,state,city,party_name,address,email,contact_no,pin_code,username,gender,password,confirmpassword,election_region,securityQuestion,securityAnswer) values ('"+fname+"','"+lname+"','"+fathername+"','"+dob+"','"+State+"','"+City+"','"+p_name+"','"+Address+"','"+email+"','"+contactnumber+"','"+Pincode+"','"+Username+"','"+gender+"','"+ Password+"','"+Confirm_password+"','"+election_region+"','"+ securityQuestion+"','"+answer+"')";
