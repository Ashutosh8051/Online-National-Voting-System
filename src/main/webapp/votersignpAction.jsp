...
<body>
	...
	try
	{
		...
		String answer=request.getParameter("t16");
			...
			String sql="insert into Voter(first_name,last_name,father_name,dob,state,city,address,email,contact_no,pin_code,username,gender,password,confirmpassword,securityQuestion,securityAnswer) values ('"+fname+"','"+lname+"','"+fathername+"','"+dob+"','"+State+"','"+City+"','"+Address+"','"+email+"','"+contactnumber+"','"+Pincode+"','"+Username+"','"+gender+"','"+ Password+"','"+Confirm_password+"','"+ securityQuestion+"','"+answer+"')";
