...
try
{
	...
	String sql="update voter set first_name='"+fname+"',last_name='"+lname+"',father_name='"+fathername+"',dob='"+dob+"',state='"+state+"',city='"+city+"',address='"+address+"',email='"+email+"',contact_no='"+contactno+"',pin_code='"+pincode+"'where voter_id='"+voterid+"'";
