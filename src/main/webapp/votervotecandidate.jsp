...
<body bgcolor="black">
	...
	<p class="p"> <b>NOTE &nbsp; :</b> After Vote if You see <i>Vote Sucessfull</i> then only your vote has been received otherwise try again</p>
	<% 
	try
		{
			...
			Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/ashu","root","Ashutosh@8051");
				String sql ="insert into result(voter_id,candidate_id) values ('"+vid+"','"+cid+"')";
